...
<html lang="en">
    ...
    <head>
        ...
        <link type="text/css" href="css/theme-sty.css" rel="stylesheet">
        <link type="text/css" href="images/icons/css/font-awesome.css" rel="stylesheet">
        <link type="text/css" href='http://fonts.googleapis.com/css?family=Open+Sans:400,600'
            rel='stylesheet'>
    </head>
    <body>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="student.php"><i class="menu-icon icon-user"></i>Manage Readers</a>
                                </li>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2024 PUP Library Management System </b>All rights reserved.
            </div>
        </div>
